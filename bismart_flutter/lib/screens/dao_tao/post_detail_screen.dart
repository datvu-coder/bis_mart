          ...
          children: [
            ...
            if ((post.videoUrl ?? '').isNotEmpty)
              Padding(
                ...
                child: PostVideoPlayer(postId: post.id),
              ),
...
// Video player extracted to post_video_player.dart (platform-conditional:
// dart:html-based on web, video_player-based on iOS/Android).
