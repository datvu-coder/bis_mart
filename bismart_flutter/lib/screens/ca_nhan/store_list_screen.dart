...
class _StoreListScreenState extends State<StoreListScreen> {
  static const _groups = ['Tất cả', 'CS', 'HO', 'I', 'II'];
  ...
  Widget _buildGroupFilterButton(StoreProvider provider) {
  ...
  void _showStoreFormDialog({Store? initial}) {
    ...
    Future<void> useCurrentLocation(BuildContext ctx, StateSetter setLocal) async {
    ...
    showResponsiveForm(
      context: context,
      title: isEdit ? 'Sửa cửa hàng' : 'Thêm cửa hàng',
      contentBuilder: (ctx, setLocal) => Column(
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () => useCurrentLocation(ctx, setLocal),
